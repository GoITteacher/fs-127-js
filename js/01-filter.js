...
// const res = numbers.filter(el => el > 10);
// console.log(res);
...
// const res = allCars.filter(car => car.make === 'Ford');
// const res = allCars.filter(car => {
//   const isFord = car.make === 'Ford';
//   const isCheap = car.price < 30000;
//   const isOnSale = car.onSale;
//   return isFord && isCheap && isOnSale;
// });

// const res = allCars.find(car => car.price < 30000);
// console.log(res);
